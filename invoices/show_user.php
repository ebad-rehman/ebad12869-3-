	...
	if(isset($_POST['show'])){
		...
		<table class = "table table-bordered alert-warning table-hover">
			...
			<thead>
				...
				<tbody>
					<?php
						$quser=mysqli_query($conn,"SELECT I.ID, I.InvoiceID, P.Brand, P.SalesPrice, I.Quantity, I.Discount, (100-I.Discount)/100*(I.Quantity*P.SalesPrice) AS Total FROM salesorder_12869 I, product P WHERE I.InvoiceID = '$InvoiceID' AND I.ProductCode = P.ProductCode");
